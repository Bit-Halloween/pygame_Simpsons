...
pygame.display.set_caption("Simpsons Game")
icone  = pygame.image.load("assets/icone.png")
pygame.display.set_icon(icone)
branco = (255,255,255)
preto = (0, 0 ,0 )
iron = pygame.image.load("assets/homer.png")
...
missel = pygame.image.load("assets/donut.png")
missileSound = pygame.mixer.Sound("assets/popup.mp3")
